  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="cursor-pointer bg-white border border-gray-200 shadow-md rounded-xl overflow-hidden max-w-4xl mx-auto mb-6 transition-transform hover:shadow-lg"
      >
        <img src={image} alt={name} className="w-full h-56 object-cover" />
        <div className="px-6 py-4">
          <h2 className="text-xl font-serif font-semibold text-gray-800 mb-1">{name}</h2>
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            {/* Modal Wrapper to stop propagation */}
            <motion.div
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h2 className="text-3xl font-serif font-bold text-gray-900 mb-1">{name}</h2>
                      {date && (
